    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        <div className="bg-white/70 border border-rose-100 rounded-2xl p-6">
          ...
          <p className="text-rose-700 mt-2">Pau, France</p>
          ...
          <div className="mt-4">
            <iframe title="Pau" src="https://www.google.com/maps?q=Pau,France&output=embed" className="w-full h-64 rounded-xl border"/>
          </div>
        </div>
